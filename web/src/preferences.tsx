...
const messages: Record<EffectiveLanguage, Record<string, string>> = {
  zh: {
    ...
    'nav.nodes': '节点', 'nav.accounts': '账户', 'nav.audit': '日志', 'nav.settings': '设置',
    ...
    'login.tooShort': '密码至少 12 个字符。', 'login.invalid': '密码错误，或主控暂时不可用。',
    ...
    'overview.next90': '近 90 天', 'overview.nodeHealth': '节点', 'overview.activity': '最近活动',
    ...
    'domain.add': '添加', 'domain.editTitle': '编辑域名', 'domain.updateSubmit': '保存', 'domain.searchPlaceholder': '搜索域名或节点', 'domain.managedTab': '已管理',
    ...
    'domain.certificateLocation': '证书', 'domain.localCertificate': '节点 /etc/ssl/{domain}', 'domain.controllerCertificate': '{domain} · {days} 天',
    ...
    'certificate.expiry': '到期', 'certificate.source': '来源', 'certificate.autoRenew': '续期',
    'certificate.distribution': '分发', 'certificate.renew': '续期', 'certificate.sync': '同步',
    'certificate.enabled': '开', 'certificate.disabled': '关', 'certificate.remaining': '{count} 天',
    ...
    'certificate.editAutomation': '编辑签发与续期', 'certificate.editAutomationHint': '管理 {domain} 的覆盖域名与自动续期。',
    ...
    'toast.pollFrequencySaved': '节点状态频率已更新。',
    ...
    'error.atlasUpdate': '无法创建 Atlas 更新任务', 'error.systemUpdate': '无法创建系统更新任务', 'error.settings': '无法保存设置',
  ...
  en: {
    ...
    'nav.nodes': 'Nodes', 'nav.accounts': 'Accounts', 'nav.audit': 'Logs', 'nav.settings': 'Settings',
    ...
    'login.tooShort': 'Password must be at least 12 characters.', 'login.invalid': 'Invalid password or controller offline.',
    ...
    'overview.next90': 'Next 90 days', 'overview.nodeHealth': 'Nodes', 'overview.activity': 'Activity',
    ...
    'domain.certificateLocation': 'Certificate', 'domain.localCertificate': 'Node /etc/ssl/{domain}', 'domain.controllerCertificate': '{domain} · {days}d',
    ...
    'certificate.expiry': 'Expiry', 'certificate.source': 'Source', 'certificate.autoRenew': 'Renew',
    'certificate.distribution': 'Copies', 'certificate.renew': 'Renew', 'certificate.sync': 'Sync',
    'certificate.enabled': 'On', 'certificate.disabled': 'Off', 'certificate.remaining': '{count}d',
    ...
    'certificate.editAutomation': 'Edit issuance & renewal', 'certificate.editAutomationHint': 'Manage names and auto-renew for {domain}.',
    ...
    'toast.pollFrequencySaved': 'Node status interval updated.',
    ...
    'error.atlasUpdate': 'Unable to queue the Atlas update', 'error.systemUpdate': 'Unable to queue the system update', 'error.settings': 'Unable to save settings',
