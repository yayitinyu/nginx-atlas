...
const messages: Record<EffectiveLanguage, Record<string, string>> = {
  zh: {
    ...
    'nav.nodes': '节点', 'nav.accounts': '账户', 'nav.audit': '审计', 'nav.settings': '设置',
    ...
    'overview.quickActions': '快捷操作', 'overview.activeRoutes': '活跃路由', 'overview.autoRenewCerts': '自动续期',
    ...
    'domain.drawerKicker': '新路由', 'domain.drawerSubtitle': '上游、证书与可选 Cloudflare DNS', 'domain.stepRoute': '路由', 'domain.stepCertificate': '证书', 'domain.stepDeploy': '部署',
    ...
    'certificate.autoRenewCount': '自动续期', 'certificate.nodeCopies': '副本',
    'certificate.searchPlaceholder': '搜索域名或指纹', 'certificate.allStatuses': '全部',
    ...
    'nodes.add': '添加', 'nodes.empty': '还没有节点', 'nodes.emptyDescription': '生成安装命令，在目标 VPS 执行。',
    ...
    'settings.title': '设置', 'settings.description': '密码、会话与运行信息。',
    ...
    'domain.nginxSettings': 'Nginx 高级设置', 'domain.nginxSettingsHint': '根据你的项目需求调整参数。',
    'domain.nginxWebsocket': '支持 WebSocket', 'domain.nginxWebsocketHint': '注入 Upgrade 与 Connection 标头，用于实时双向通信。',
    'domain.nginxHttp2': 'HTTP/2 协议', 'domain.nginxHttp2Hint': '开启 HTTP/2 多路复用以提高加载性能。',
    'domain.nginxGzip': '开启 Gzip 压缩', 'domain.nginxGzipHint': '自动压缩静态资源与 API 响应。',
  ...
  en: {
    ...
    'nav.nodes': 'Nodes', 'nav.accounts': 'Accounts', 'nav.audit': 'Audit', 'nav.settings': 'Settings',
    ...
    'overview.quickActions': 'Quick actions', 'overview.activeRoutes': 'Active routes', 'overview.autoRenewCerts': 'Auto-renew',
    ...
    'domain.drawerKicker': 'New route', 'domain.drawerSubtitle': 'Upstream, certificate, optional Cloudflare DNS', 'domain.stepRoute': 'Route', 'domain.stepCertificate': 'Cert', 'domain.stepDeploy': 'Deploy',
    ...
    'certificate.autoRenewCount': 'Auto-renew', 'certificate.nodeCopies': 'Copies',
    'certificate.searchPlaceholder': 'Search domain or fingerprint', 'certificate.allStatuses': 'All',
    ...
    'nodes.add': 'Add', 'nodes.empty': 'No nodes yet', 'nodes.emptyDescription': 'Generate an install command for the target VPS.',
    ...
    'settings.title': 'Settings', 'settings.description': 'Password, session, and runtime info.',
    ...
    'domain.nginxSettings': 'Nginx settings', 'domain.nginxSettingsHint': 'Adjust parameters based on your project requirements.',
    'domain.nginxWebsocket': 'WebSocket support', 'domain.nginxWebsocketHint': 'Injects Upgrade and Connection headers for real-time communication.',
    'domain.nginxHttp2': 'HTTP/2 protocol', 'domain.nginxHttp2Hint': 'Enables HTTP/2 multiplexing for better performance.',
    'domain.nginxGzip': 'Gzip compression', 'domain.nginxGzipHint': 'Compresses static assets and API responses automatically.',
