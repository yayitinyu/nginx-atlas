...
const messages: Record<EffectiveLanguage, Record<string, string>> = {
  zh: {
    ...
    'domain.add': '添加域名', 'domain.searchPlaceholder': '搜索域名、节点或端口', 'domain.managedTab': '已管理',
    'domain.discoveredTab': '节点发现', 'domain.discoveredTitle': '节点现有 Nginx 域名',
    'domain.discoveredDescription': '代理从 nginx -T 提取安全元数据；接管只加入监控，不会改写原配置。',
    'domain.adopt': '加入管理', 'domain.adopted': '已管理', 'domain.noDiscovered': '没有新的节点域名',
    ...
    'domain.removeAction': '移除域名', 'domain.stopManaging': '停止管理',
    ...
    'domain.drawerSubtitle': '配置路由、证书与多节点同步', 'domain.stepRoute': '路由', 'domain.stepCertificate': '证书', 'domain.stepDeploy': '部署',
    ...
    'settings.title': '设置', 'settings.description': '管理界面偏好、管理员凭据与运行边界。',
  ...
  en: {
    ...
    'overview.viewNodes': 'View all nodes', 'overview.waitingReport': 'Waiting for report', 'overview.nginxUndetected': 'Nginx not detected',
    ...
    'domain.add': 'Add domain', 'domain.searchPlaceholder': 'Search domain, node, or port', 'domain.managedTab': 'Managed',
    'domain.discoveredTab': 'Discovered', 'domain.discoveredTitle': 'Existing Nginx domains',
    'domain.discoveredDescription': 'Agents extract safe metadata from nginx -T. Adopting adds monitoring without rewriting the original configuration.',
    'domain.adopt': 'Add to management', 'domain.adopted': 'Managed', 'domain.noDiscovered': 'No new node domains',
    ...
    'domain.removeAction': 'Remove domain', 'domain.stopManaging': 'Stop managing',
    ...
    'domain.drawerSubtitle': 'Configure routing, certificates, and multi-node distribution', 'domain.stepRoute': 'Route', 'domain.stepCertificate': 'Certificate', 'domain.stepDeploy': 'Deploy',
    ...
    'settings.title': 'Settings', 'settings.description': 'Manage interface preferences, administrator credentials, and runtime boundaries.',
