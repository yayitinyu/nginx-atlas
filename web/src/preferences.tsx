...
const messages: Record<EffectiveLanguage, Record<string, string>> = {
  zh: {
    ...
    'overview.routes': '域名路由', 'overview.searchDomain': '搜索域名', 'overview.noDomain': '暂无域名',
    ...
    'domain.showing': '{shown}/{total}', 'domain.transactionNote': '变更前会执行 nginx -t',
    ...
    'domain.deployProof': '先 nginx -t，失败会自动回滚。',
  ...
  en: {
    ...
    'overview.routes': 'Routes', 'overview.searchDomain': 'Search domains', 'overview.noDomain': 'No domains',
    ...
    'domain.showing': '{shown}/{total}', 'domain.transactionNote': 'Changes run nginx -t first',
    ...
    'domain.deployProof': 'Runs nginx -t first; rolls back on failure.',
